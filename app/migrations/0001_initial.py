# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2018-01-03 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scid', models.PositiveIntegerField(default=560421, verbose_name='\u041d\u043e\u043c\u0435\u0440 \u0432\u0438\u0442\u0440\u0438\u043d\u044b')),
        ...
        migrations.AddField(
            model_name='order',
            name='payment_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Payments', verbose_name='\u041f\u043b\u0430\u0442\u0435\u0436'),
        ),
    ]
